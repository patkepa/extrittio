...
pub struct RepositorySetInput {
    ...
    pub metrics: Arc<dyn crate::metrics::MetricsRepository>,
    pub audit: Arc<dyn crate::audit::AuditRepository>,
    pub analytics: Arc<dyn crate::analytics::AnalyticsRepository>,
...
pub struct RepositorySet {
    ...
    metrics: Arc<dyn crate::metrics::MetricsRepository>,
    audit: Arc<dyn crate::audit::AuditRepository>,
    analytics: Arc<dyn crate::analytics::AnalyticsRepository>,
...
pub(crate) struct RepositorySetParts {
    ...
    pub(crate) metrics: Arc<dyn crate::metrics::MetricsRepository>,
    pub(crate) audit: Arc<dyn crate::audit::AuditRepository>,
    pub(crate) analytics: Arc<dyn crate::analytics::AnalyticsRepository>,
