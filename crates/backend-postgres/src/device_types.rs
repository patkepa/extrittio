...
use crate::models::{DeviceType, NewDeviceType, UpdateDeviceType};
use crate::schema::{device_types, devices};
...
#[derive(Clone)]
pub struct PostgresDeviceTypeRepository {
    executor: PostgresExecutor,
}
impl PostgresDeviceTypeRepository {
...
#[async_trait]
impl DeviceTypeRepository for PostgresDeviceTypeRepository {
    async fn list(
        &self,
        tenant: &TenantId,
        limit: i64,
