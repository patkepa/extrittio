...
board = esp32dev
framework = arduino
lib_extra_dirs = ../../clients/arduino
lib_deps =
...
Arduino libraries folder, then copy or symlink `clients/arduino/Extrittio` into
the same folder.
...
sync with `crates/common/src/protos/telemetry.proto`.
