#ifndef EXTRITTIO_ZENOH_GENERIC_CONFIG_H
#define EXTRITTIO_ZENOH_GENERIC_CONFIG_H

/* Feature profile for the pinned zenoh-pico 1.9.0 Zephyr client. */
